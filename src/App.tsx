          ...
          {!isScanning && !result && !error && (
            ...
            >
              <div className={`max-w-2xl mx-auto text-center mb-12 transition-opacity duration-300 ${isCameraOpen ? 'opacity-0' : 'opacity-100'}`}>
                <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-gray-50 mb-4 tracking-tight">QR Security Intelligence <span className="text-xs opacity-50">v1.1</span></h2>
